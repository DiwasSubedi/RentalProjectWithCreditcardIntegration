...
<body>
<div class="container">
<p><spring:message code="welcome" text="default text" />	</p>
    	<div class="row">
							...
							<div class="col-lg-12">
								<form id="login-form" action="postLogin" method="post" role="form" style="display: block;">
									<div class="form-group">
										<p><spring:message code="username" text="default text" />	
										<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username" value=""></p>
									</div>
									<div class="form-group">
									...
									<div class="form-group text-center">
										<input type="checkbox" tabindex="3" class="" name="keepMe" id="keepMe">
